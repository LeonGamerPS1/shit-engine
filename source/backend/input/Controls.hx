...
class Controls
{
	...
	public var keyboardBinds(get, null):Map<String, Array<FlxKey>>;
	public var gamepadBinds(get, null):Map<String, Array<FlxGamepadInputID>>;
	...
	// IGNORE THESE
	public static var inputSystem:Controls;
